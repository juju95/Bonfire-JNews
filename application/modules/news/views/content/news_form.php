...
<div class='admin-box'>
    ...
    <fieldset>
        <legend><?php echo e('General Infos') ?></legend>
        ...
        <div class="control-group <?php echo iif ( form_error('date'), 'error'); ?>">
            ...
            <div class="controls">
                <input type="text" name="date" id="date" value="<?php echo (isset($article) && isset($article->date) && !empty($article->date)) ? date('Y/m/d H:i',$article->date) : ($this->input->post('date') ? set_value(date('Y/m/d H:i',strtotime($this->input->post('date')))) : date('Y/m/d H:i',time())); ?>" />
	...
	<fieldset>
		...
		<div class="control-group <?php echo iif ( form_error('date_published'), 'error'); ?>">
			...
			<div class="controls">
				<input type="text" name="date_published" id="date_published" value="<?php echo (isset($article) && isset($article->date_published) && !empty($article->date_published)) ? date('Y/m/d H:i',$article->date_published) : ($this->input->post('date_published') ? set_value(date('Y/m/d H:i',strtotime($this->input->post('date_published')))) : date('Y/m/d H:i',time())) ?>" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<span class="inline-help">
					<?php echo (isset($article) ? date('Y/m/d h:i:s A',$article->created_on) : 'Unknown'); ?> by <?php echo (isset($article) ? find_author_name($article->created_by) : 'Unknown'); ?>
				</span>
			</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<span class="inline-help"><?php echo (isset($article) ? date('Y/m/d h:i:s A',$article->modified_on) : 'Unknown'); ?> by <?php echo (isset($article) ? find_author_name($article->modified_by) : 'Unknown'); ?></span>
			</div>
		</div>
		<?php endif; ?>
...
<?php
	...
	*/
	...
	$("#date, #date_published").datetimepicker();
